book-text-epistemics1 = ВОЗДЕЙСТВИЕ ВЫСОКОГО УРОВНЯ МЕРЦАНИЯ
      ...
      Его величайшим экспериментом стало… поднять уровень мерцания до предела — настолько, что даже наш грамматевт не мог уже его измерить.
