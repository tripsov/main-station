...
mapping-template-upload = Аплоад
...
mapping-template-mantis = Мантис
mapping-template-rndcanisters = Канистры РНД
...
mapping-template-wardensoffice = Кабинет Надзирателя
...
mapping-template-justice = Юстиция
