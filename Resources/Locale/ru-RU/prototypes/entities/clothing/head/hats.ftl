...
ent-ClothingHeadHatBeretHoS = берет главы службы безопасности
    ...
    .suffix = { "" }
ent-ClothingHeadHatBeretWarden = берет Надзирателя
    .desc = Фирменный голубой берет с эмблемой Надзирателя. Для офицеров, которые предпочитают стиль безопасности.
    .suffix = { "" }
