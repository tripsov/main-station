...
ent-ClothingOuterWinterViro = зимнее пальто вирусолога
    .desc = { ent-ClothingOuterWinterCoat.desc }
    .suffix = { "" }
ent-ClothingOuterWinterWarden = зимнее бронепальто Надзирателя
    .desc = Прочное, утилитарное зимнее пальто, предназначенное для защиты Надзирателя от любых угроз, связанных с бригом, и переохлаждением.
    .suffix = { "" }
