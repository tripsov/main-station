...
ent-MobRaccoonMorticia = Мортиша
    ...
    .suffix = { "" }
ent-MobAlexander = Вячеслав Метакоопов
    .desc = Теневой правитель Корвакса.
    .suffix = { "" }
...
ent-MobSecDogLaika = Лайка
    .desc = Подобно своей тезке, Лайка — это экземпляр неопределенной породы, только что с улицы и готова к бою.
    .suffix = { "" }
